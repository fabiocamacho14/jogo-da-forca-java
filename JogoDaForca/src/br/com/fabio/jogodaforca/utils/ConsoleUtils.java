package br.com.fabio.jogodaforca.utils;

import java.io.BufferedReader;
import java.io.IOException;
import java.io.InputStreamReader;

import br.com.fabio.jogodaforca.CaractereInvalidoException;
import br.com.fabio.jogodaforca.JogoDaForcaException;
...
public class ConsoleUtils {
	 ...
	 * 				uma letra for digitada e se o caractere digitado não for uma
	 * 				letra de A a Z
	 * @throws {link IOException} Se houver algum problema de I/O relacionado
	 * 			à leitura do console
	 */
