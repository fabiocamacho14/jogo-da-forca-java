...
import br.com.fabio.jogodaforca.utils.ConsoleUtils;
	...
	public void iniciar() throws JogoDaForcaException {
		...
		while (true) {
			...
			try {
				...
				// Se ele já digitou essa letra anteriormente, lança uma exceção
				if (letrasUsadas.contains(letra)) {
					throw new CaractereInvalidoException("Esta letra já foi utilizada");
				}
				
				// Adiciona a letra digitada à lista de letras usadas
