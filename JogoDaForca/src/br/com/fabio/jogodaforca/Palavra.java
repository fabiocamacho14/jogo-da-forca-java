...
public class Palavra {
	...
	/**
	 * Constante que indica que o caractere que deve ser mostrado ao usuário enquanto ele não descobre a letra
	 */
	...
	/**
	 * Retorna a palavra. Se o jogador ainda não descobriu determinada letra, o {@link #CARACTERE_SECRETO} é mostrado
	 * no lugar dela.
 ...
 * @return true se a letra existir; false caso não exista
 */
	 ...
	 * @return true se acertou; false caso não
	 */
	public boolean acertouPalavra() {
		...
		// Adiciona todos os caracteres das palavras no conjunto. Se o caractere for repetido, ele
		// não será adicionado (conjuntos não permitem elementos duplicados)
		for (int i = 0; i < letrasArray.length; i++) {
			letras.add(letrasArray[i]);
		}
		
		// Se o conjunto com os caracteres da palavra tiver os mesmos elementos do conjunto de
		// caracteres encontrados pelo jogador, significa que ele já acertou todas as letras da palavra
